...
void UiMenuInit(Ui *ui)
{
    UiButtTex_init(&ui->butt.play, (Vector2) { 0, -32 }, (Vector2) { 64, 64 }
        , ANCHOR_SW, "res/ui/play.png", NULL);

    UiButtTex_init(&ui->butt.nbBlobLeft, (Vector2) { 120, -32 }
        , (Vector2) { 64, 64 }, ANCHOR_SW, "res/ui/left_arrow.png", NULL);
    UiButtTex_init(&ui->butt.nbBlobRight, (Vector2) { 200, -32 }
